/**
 * @license jQuery JavaScript Library v1.9.1 for Closure-compiler
 * http://jquery.com/
 *
 * Includes Sizzle.js
 * http://sizzlejs.com/
...
var
	...
	core_version = "1.9.1 for Closure-compiler",
...
jQuery.expandedEach = jQuery.each;// String to Object options format cache
var optionsCache = {};
...
jQuery.support = ( /** @suppress {uselessCode} */ function() {
	...
	jQuery.expandedEach([ "submit", "change", "focusin" ], function( i, value ) {
		div.setAttribute( eventName = "on" + value, "t" );
		support[ value + "Bubbles" ] = eventName in window || div.attributes[ eventName ].expando === false;
	});
		...
		return this.each(function() {
			if ( type === "string" ) {
				...
				while ( (className = classNames[ i++ ]) ) {
					...
					(state ? jQuery.fn.addClass : jQuery.fn.removeClass).call( self, className );
				}
	...
	special_event["change"] = /** @type {jQuerySpecialEvent} */ ({
		...
		setup: function() {
			...
			jQuery.event.add( this, "beforeactivate._change",
				/** @this {Document|Window|Element|Node} */ function( e ) {
					var elem = e.target;
 ...
 * http://sizzlejs.com/
 */
/** @type {function(Window,undefined=)} */ (function( window, undefined ) {
...
var i,
	...
	hasDuplicate = false,
	sortOrder = function(x, y) { return 0; },
 ...
 * @param {Array.<Element|Node|Document|Window>=} results
 * @param {*=} seed
 * @return {Array.<Element|Node|Document|Window>}
 */
...
setDocument = Sizzle.setDocument = function( node ) {
	...
	// Name
	Expr.find["NAME"] = support.getByName && function( name, context ) {
...
Expr = Sizzle.selectors = {
	...
	pseudos: {
		...
		"selected": /** @suppress {uselessCode} */ function( elem ) {
 ...
 */
function setFilters() {}
//prevent prototype devirtualization
...
var
	...
	// _load = jQuery.fn.load, //deprecated
 ...
 * Fixes #9887
 * @param {jQuery.AjaxSettings|Object.<string,*>} target
 * @param {jQuery.AjaxSettings|Object.<string,*>} src
...
/**
 * @param {string} url
 * @param {(Object|string|function(string,string,XMLHttpRequest))=} params
...
jQuery.expandedEach( [ "get", "post" ], function( i, method ) {
	/**
	 * @param {string} url
	 * @param {(Object.<string,*>|string|function(string,string,jQuery.jqXHR))=} data
	 * @param {(function(string,string,jQuery.jqXHR)|string)=} callback
	 * @param {string=} type
	 * @return {!jQuery.jqXHR}
	 */
	jQuery[ method ] = function( url, data, callback, type ) {
		...
		if ( jQuery.isFunction( data ) ) {
			type = /**@type {string} */ ( type || callback );
			callback = /** @type {function(string,string,jQuery.jqXHR)} */ ( data );
			data = undefined;
		}
...
jQuery.extend({
	 ...
	 * @param {Object.<string,*>|jQuery.AjaxSettings} target
	 * @param {(Object.<string,*>|jQuery.AjaxSettings)=} settings
	 * @return {!jQuery.AjaxSettings}
	 */
	...
	/**
	 * Main method
	 * @param {(string|Object.<string,*>|jQuery.AjaxSettings)=} url
	 * @param {(Object.<string,*>|jQuery.AjaxSettings)=} options
	 * @return {!jQuery.jqXHR}
	 */
	ajax: function( url, options ) {
		...
		if ( typeof url === "object" ) {
			options = /** @type {Object.<string,*>|jQuery.AjaxSettings} */ ( url );
			url = undefined;
		}
		...
		if ( s.data && s.processData && typeof s.data !== "string" ) {
			s.data = jQuery.param( /** @type {Object.<string,*>} */ ( s.data ), s.traditional );
		}
	...
	/**
	 * @param {string} url
	 * @param {function(string,string,jQuery.jqXHR)=} callback
	 * @return {!jQuery.jqXHR}
	 */
